       ...
       PrintWriter out = response.getWriter();
        try {
          ...
          int uui;
            ...
            feedback=request.getParameter("text");
            ...
            f.setStar(star);
              ...
              out.println("<h1> fire   uid :"+ uui+ "</h1>");
            QueryDAO qd=new QueryDAO();
            if(qd.addFeedbak(f))
            {
                  out.println("<h1>Servlet  Feedback   </h1>");
            session.setAttribute("msg","Thank You For Your Feedback  \n We Will Work ON This ");
